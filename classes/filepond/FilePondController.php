...
class FilePondController extends BaseController
{
    ...
    public function upload(Request $request): \Illuminate\Http\Response
    {
        ...
        if ($this->checkInvalidSize()) {
            $error = e(trans('thewebsiteguy.formwizard::lang.classes.FilePond.error_filesize'));
        ...
        if ($this->checkInvalidFile()) {
            $error = e(trans('thewebsiteguy.formwizard::lang.classes.FilePond.error_filetype'));
            return Response::make($error, 422, [
                'Content-Type' => 'text/plain',
            ]);
        }
        ...
        if (!$this->file->move($filePathParts['dirname'], $filePathParts['basename'])) {
            $error = e(trans('thewebsiteguy.formwizard::lang.classes.FilePond.error_savefile'));
