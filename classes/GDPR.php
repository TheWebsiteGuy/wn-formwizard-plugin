...
class GDPR
{
    public static function cleanRecords()
    {
        ...
        if (!$gdpr_enable) {
            Flash::error(e(trans('thewebsiteguy.formwizard::lang.classes.GDPR.alert_gdpr_disabled')));
            return;
        }
        ...
        Flash::error(e(trans('thewebsiteguy.formwizard::lang.classes.GDPR.alert_invalid_gdpr')));
    }
}
