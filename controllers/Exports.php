...
{
    public $requiredPermissions = ['thewebsiteguy.formwizard.access_exports'];
    ...
    {
        parent::__construct();
        BackendMenu::setContext('thewebsiteguy.formwizard', 'forms', 'exports');
    }

    public function index()
    {
        $this->pageTitle = e(trans('thewebsiteguy.formwizard::lang.controllers.exports.title'));
    ...
    public function csv()
    {
        ...
        if (post('Record.options_metadata')) {
            $meta_headers = [
                e(trans('thewebsiteguy.formwizard::lang.controllers.records.columns.id')),
                e(trans('thewebsiteguy.formwizard::lang.controllers.records.columns.group')),
                e(trans('thewebsiteguy.formwizard::lang.controllers.records.columns.ip')),
                e(trans('thewebsiteguy.formwizard::lang.controllers.records.columns.created_at')),
            ];
        ...
        if (post('Record.options_files')) {
            $headers[] = e(trans('thewebsiteguy.formwizard::lang.controllers.records.columns.files'));
        }
