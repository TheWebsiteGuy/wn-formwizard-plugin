...
class BackendHelpersTest extends PluginTestCase
{
    ...
    {
        $this->_loginUser();
        $expect = Backend::url("thewebsiteguy/formwizard/records");
        $bh = new BackendHelpers();
        $this->assertEquals($expect, $bh->getBackendURL([
            'thewebsiteguy.formwizard.access_records' => 'thewebsiteguy/formwizard/records',
            'thewebsiteguy.formwizard.access_exports' => 'thewebsiteguy/formwizard/exports',
        ], 'thewebsiteguy.formwizard.access_records'));
    }
