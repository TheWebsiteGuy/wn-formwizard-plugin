...
return [
    ...
    'components' => [
        ...
        'shared' => [
            ...
            'recaptcha_warn' => 'Внимание: reCAPTCHA настроена не правильно. Пожалуйста, перейдите в Настройки > CMS > Form Wizard и заполните все обязательные поля.',
            ...
            'mail_template' => ['title' => 'Шаблон письма', 'description' => 'Используйте собственный шаблон письма. Укажите код шаблона, например, "thewebsiteguy.formwizard::mail.notification" (находится в разделе Настройки -> Почтовые шаблоны). Оставьте пустым, чтобы использовать по умолчанию.'],
